    ...
    return (
      <>
        ...
        <div className=" w-full py-[4rem] bg-slate-100 bg-gradient-to-b from-white">
          <div className="md:flex justify-around space-y-16 md:space-y-0     md:h-[30rem]">
            <div className=" font-roboto  lg:mt-[5rem]   md:w-1/2 md:pl-[5rem] pl-6">
            ...
            <div className="   flex flex-col items-center md:w-1/2 px-4 py-2 ">
              <img
                src={aboutlog}
                alt=""
                className=" h-[60vh]  md:w-[32vw] md:h-[70vh] brightness-75 object-cover object-middle   rounded-md"
              />
            </div>
          </div>
        </div>
        ...
        <div className=" bg-sky-900 font-roboto w-full xl:h-[19rem] justify-evenly  ">
          <div className="md:flex  md:justify-center  space-y-12 md:space-y-0  lg:px-[6rem]   h-full md:pt-20 md:pb-20  py-8 container mx-auto">
            <div className=" md:w-[40rem] flex-col s  flex xl:h-36 md:flex-row items-center space-x-6  ">
            ...
            <div className=" md:w-[40rem] flex-col  flex xl:h-36 lg:flex-row items-center space-x-4   ">
